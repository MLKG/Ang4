...
export class ProductService {
  ...
  private products: Product[] = [
    new Product(1, '第一个商品1', 1.99, 3.5, '这是第一个商品的描述', ['电子产品', '硬件设备']),
    new Product(2, '第二个商品1', 2.99, 2.5, '这是第二个商品的描述', ['硬件设备']),
    new Product(3, '第三个商品2', 3.99, 4.5, '这是第三个商品的描述', ['电子产品']),
    new Product(4, '第四个商品3', 4.99, 2.5, '这是第四个商品的描述', ['电子产品', '硬件设备']),
    new Product(5, '第五个商品3', 5.99, 3.5, '这是第五个商品的描述', ['图书产品']),
    new Product(6, '第六个商品3', 6.99, 1.5, '这是第六个商品的描述', ['电子产品', '高级设备'])
  ];
